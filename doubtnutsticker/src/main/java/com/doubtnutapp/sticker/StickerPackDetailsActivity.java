...
public class StickerPackDetailsActivity extends AddStickerPackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        packTrayIcon.setImageURI(StickerPackLoader.getStickerAssetUri(getApplicationContext(), stickerPack.identifier, stickerPack.trayImageFile));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.action_info && stickerPack != null) {
            ...
            Uri trayIconUri = StickerPackLoader.getStickerAssetUri(getApplicationContext(), stickerPack.identifier, stickerPack.trayImageFile);
