...
public class StickerPreviewAdapter extends RecyclerView.Adapter<StickerPreviewViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final StickerPreviewViewHolder stickerPreviewViewHolder, final int i) {
        ...
        Glide.with(stickerPreviewViewHolder.stickerPreviewView).load(
                StickerPackLoader.getStickerAssetUri(stickerPreviewViewHolder.stickerPreviewView.getContext(),stickerPack.identifier, stickerPack.getStickers().get(i).imageFileName)
