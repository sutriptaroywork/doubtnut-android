...
public class SpannedSubjectTest {
  ...
  public void alignmentSpan_success() {
    SpannableString spannable =
        createSpannable(
            new Standard(Alignment.ALIGN_OPPOSITE), Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
  ...
  public void alignmentSpan_wrongAlignment() {
    SpannableString spannable =
        createSpannable(new Standard(Alignment.ALIGN_OPPOSITE));
  ...
  public void alignmentSpan_wrongFlags() {
    checkHasSpanFailsDueToFlagMismatch(
        new Standard(Alignment.ALIGN_OPPOSITE),
        (subject, start, end) ->
  ...
  public void noAlignmentSpan_success() {
    SpannableString spannable =
        createSpannableWithUnrelatedSpanAnd(new Standard(Alignment.ALIGN_OPPOSITE));
