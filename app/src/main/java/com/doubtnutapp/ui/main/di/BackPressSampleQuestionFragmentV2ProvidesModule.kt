...
@Module
object BackPressSampleQuestionFragmentV2ProvidesModule {

    @Provides
    @JvmStatic
    fun provideCameraServiceApi(@ApiRetrofit retrofit: Retrofit) = retrofit.create(
        CameraScreenApiService::class.java
    )
