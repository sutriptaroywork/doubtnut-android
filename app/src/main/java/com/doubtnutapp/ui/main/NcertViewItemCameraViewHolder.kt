...
import com.doubtnutapp.databinding.ItemNcertItemCameraViewBinding
 ...
 */
class NcertViewItemCameraViewHolder(private val binding: ItemNcertItemCameraViewBinding) : BaseViewHolder<NcertViewItemEntity>(binding.root) {
    override fun bind(data: NcertViewItemEntity) {
        ...
        binding.root.setOnClickListener {
            performAction(
                    PublishEvent(
                            AnalyticsEvent(
                                    EventConstants.NCERT_RE_ENTRY_CAMERA_CLICK,
