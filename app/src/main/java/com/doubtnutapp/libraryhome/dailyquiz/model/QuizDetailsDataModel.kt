package com.doubtnutapp.libraryhome.dailyquiz.model
...
data class QuizDetailsDataModel(
        ...
        val subscriptionData: List<QuizSubscriptionData>? = null,
        val bottomWidgetEntity: BottomWidgetEntity?
) {
    @Keep
    data class QuizSubscriptionData(
            val id: Int,
            val testId: Int,
            val studentId: Int,
