...
class CourseChangeDropDownMenu(private val context: Context, val list: List<CourseSelectionData.DropDownData>) : PopupWindow(context) {
    private var rvCategory: RecyclerView? = null
    private var dropdownAdapter: CourseChangeDropDownAdapter? = null
    fun setCategorySelectedListener(filterSelectedListener: CourseChangeDropDownAdapter.FilterSelectedListener?) {
    ...
    private fun setupView() {
        ...
        dropdownAdapter = CourseChangeDropDownAdapter(list)
