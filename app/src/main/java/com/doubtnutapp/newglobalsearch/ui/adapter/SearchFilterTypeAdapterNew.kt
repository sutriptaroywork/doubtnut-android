...
import com.doubtnutapp.newglobalsearch.ui.viewholder.SearchFilterTypeViewHolderNew

class SearchFilterTypeAdapterNew(private val actionPerformer: ActionPerformer) :
    RecyclerView.Adapter<SearchFilterTypeViewHolderNew>(), ActionPerformer {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): SearchFilterTypeViewHolderNew {
        return SearchFilterTypeViewHolderNew(
            parent.context,
            LayoutInflater.from(parent.context)
                .inflate(R.layout.item_filter_type_ias, parent, false),
            this
        )
    }
    ...
    override fun onBindViewHolder(holder: SearchFilterTypeViewHolderNew, position: Int) {
