...
import com.doubtnutapp.databinding.ItemTrendingGridListBinding
...
class TrendingGridFeedViewHolder(val binding: ItemTrendingGridListBinding) : BaseViewHolder<TrendingSearchDataListViewItem>(binding.root) {
