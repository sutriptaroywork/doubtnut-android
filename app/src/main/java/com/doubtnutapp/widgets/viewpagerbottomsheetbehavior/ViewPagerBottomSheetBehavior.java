...
public class ViewPagerBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    View findScrollingChild(View view) {
        ...
        if (view instanceof ViewPager) {
            ...
            View currentViewPagerChild = ViewPagerUtils.INSTANCE.getCurrentView(viewPager);
    ...
    private void setSystemGestureInsets(@NonNull CoordinatorLayout parent) {
        if (VERSION.SDK_INT >= VERSION_CODES.M && !isGestureInsetBottomIgnored()) {
            WindowInsets windowInsets = parent.getRootWindowInsets();
            if (windowInsets != null) {
                int systemMandatoryInsetsBottom = windowInsets.getSystemWindowInsetBottom();
