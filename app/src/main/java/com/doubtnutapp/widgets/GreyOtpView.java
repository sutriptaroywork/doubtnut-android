...
public class GreyOtpView extends LinearLayout {
    ...
    public GreyOtpView(Context context) {
        super(context);
        init(null);
    }

    public GreyOtpView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public GreyOtpView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void generateViews(TypedArray styles) {
        if (length > 0) {
            ...
            int backgroundColor =
                    styles.getColor(R.styleable.OtpView_text_background_color, Color.LTGRAY);
