...
import com.doubtnutapp.examcorner.repository.ExamCornerRepository
...
class ExamCornerViewModel @Inject constructor(
    private val examCornerRepository: ExamCornerRepository,
    ...
    private val _examCornerLiveData: MutableLiveData<Outcome<ApiExamCornerData>> = MutableLiveData()
    val examCornerLiveData: LiveData<Outcome<ApiExamCornerData>>
    ...
    fun fetchExamCornerData(filterType: String, page: Int) {
        ...
        viewModelScope.launch {
            examCornerRepository.fetchExamCornerData(filterType, page)
                .map {
