package com.doubtnutapp.topicboostergame.ui.viewholder
...
import kotlinx.android.synthetic.main.item_topic_booster_game_quiz_option.view.*

/**
 * Created by devansh on 1/3/21.
 */
class TopicBoosterGameQuizOptionViewHolder(containerView: View) :
    ...
    override fun bind(data: Triple<String, Int, Boolean>) {
        binding.apply {
            ...
            root.setOnClickListener {
                performAction(TopicBoosterGameQuizOptionSelected(adapterPosition))
            }
        }
    }
