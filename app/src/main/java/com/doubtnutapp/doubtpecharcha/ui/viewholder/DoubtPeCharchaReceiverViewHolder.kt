...
import com.doubtnutapp.databinding.ItemDoubtPeCharchaReceiverBinding
import com.doubtnutapp.videoPage.ui.VideoPageActivity

class DoubtPeCharchaReceiverViewHolder(itemView: View) :
    BaseViewHolder<LiveClassChatData>(itemView) {

    val binding = ItemDoubtPeCharchaReceiverBinding.bind(itemView)
