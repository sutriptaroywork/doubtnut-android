...
public class StickyHeadersLinearLayoutManager<T extends RecyclerView.Adapter & StickyHeaders>
    ...
    private void measureAndLayout(View stickyHeader) {
        ...
        ViewGroup.MarginLayoutParams layoutParams = (ViewGroup.MarginLayoutParams) stickyHeader.getLayoutParams();
        if (getOrientation() == VERTICAL) {
            stickyHeader.layout(getPaddingLeft() + layoutParams.leftMargin, 0, getWidth() - getPaddingRight() - layoutParams.rightMargin, stickyHeader.getMeasuredHeight());
        } else {
