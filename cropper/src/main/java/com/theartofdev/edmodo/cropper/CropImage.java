...
public final class CropImage {
    ...
    /**
     * The key used to pass crop image options to {@link CropImageActivity} or {@link CropImageFragment}.
     */
    public static final String CROP_IMAGE_EXTRA_OPTIONS = "CROP_IMAGE_EXTRA_OPTIONS";

    /**
     * The key used to pass crop image rectf to {@link CropImageActivity} or {@link CropImageFragment}.
     */
    public static final String CROP_IMAGE_EXTRA_RECTF = "CROP_IMAGE_EXTRA_RECTF";
...
//   */
    ...
    /**
     * Create {@link FragmentBuilder} instance to start {@link CropImageActivity} to crop the given
     * image.<br>
     * Result will be received in {@link Fragment#onActivityResult(int, int, Intent)} and can be
     * retrieved using {@link #getActivityResult(Intent)}.
     *
     * @param uri the image Android uri source to crop or null to start a picker
     * @return builder for CropImageFragment
     */
    public static FragmentBuilder fragment(@Nullable Uri uri) {
        return new FragmentBuilder(uri);
    }
    ...
    public static String getActivityResult1(@Nullable Intent data) {
        return data != null ? data.getStringExtra("lng") : null;
    }

    public static String getActivityResultEvents(@Nullable Intent data) {
        return data != null ? data.getStringExtra("check_back") : null;
    }
    ...
    public static final class ActivityBuilder {
        ...
        public Intent getIntent(@NonNull Context context, @Nullable Class<?> cls) {
            mOptions.validate();
            return getIntent(context, cls, new Bundle());
        }

        public Intent getIntent(@NonNull Context context, @Nullable Class<?> cls, Bundle bundle) {
            mOptions.validate();
            ...
            bundle.putParcelable(CROP_IMAGE_EXTRA_RECTF, mOptions.cropWindowRectF);
        ...
        public void start(@NonNull Activity activity) {
            mOptions.validate();
            activity.startActivityForResult(getIntent(activity, CropImageActivity.class), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
        }

        public void start(@NonNull Activity activity, Bundle bundle) {
            mOptions.validate();
            activity.startActivityForResult(getIntent(activity, CropImageActivity.class, bundle), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
        }
         ...
         */
        public void start(@NonNull Context context, @NonNull Fragment fragment, Bundle bundle) {
            fragment.startActivityForResult(getIntent(context, CropImageActivity.class, bundle), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
        }
        ...
        public ActivityBuilder setCropWindow(RectF cropWindowRectF) {
            mOptions.cropWindowRectF = cropWindowRectF;
            return this;
        }
    ...
    /**
     * Builder used for creating Image Crop Fragment by user request.
     */
    public static final class FragmentBuilder {
        ...
        private FragmentBuilder(@Nullable Uri source) {
            mSource = source;
            mOptions = new CropImageOptions();
        }

        /**
         * Get {@link CropImageFragment} intent to start the activity.
         */
        public Bundle getArguments(@NonNull Context context, @Nullable Class<?> cls, Bundle bundle) {
            mOptions.validate();
            bundle.putParcelable(CROP_IMAGE_EXTRA_SOURCE, mSource);
            bundle.putParcelable(CROP_IMAGE_EXTRA_OPTIONS, mOptions);
            bundle.putParcelable(CROP_IMAGE_EXTRA_RECTF, mOptions.cropWindowRectF);
        ...
        /**
         * add {@link CropImageFragment}.
         *
         * @param activity - calling activity to show dialog fragment
         * @param bundle - argument to dialog fragment
         */
        @RequiresApi(api = Build.VERSION_CODES.HONEYCOMB)
        public void add(@NonNull FragmentActivity activity, Bundle bundle) {
            mOptions.validate();
            CropImageFragment cropImageFragment = CropImageFragment.Companion.newInstance();
            cropImageFragment.setArguments(getArguments(activity, CropImageFragment.class, bundle));
            cropImageFragment.show(activity.getSupportFragmentManager(), cropImageFragment.getTag());
        }
         ...
         */
        @RequiresApi(api = Build.VERSION_CODES.HONEYCOMB)
        public void add(@NonNull FragmentActivity activity, Bundle bundle, @IdRes int containerId) {
            mOptions.validate();
            CropImageFragment cropImageFragment = CropImageFragment.Companion.newInstance();
            cropImageFragment.setArguments(getArguments(activity, CropImageFragment.class, bundle));
            activity.getSupportFragmentManager().beginTransaction().add(containerId, cropImageFragment, cropImageFragment.getTag()).commit();
        }
         ...
         * <i>Default: RECTANGLE</i>
         */
        public FragmentBuilder setCropShape(@NonNull CropImageView.CropShape cropShape) {
            mOptions.cropShape = cropShape;
            return this;
        }
         ...
         * <i>Default: 3dp</i>
         */
        public FragmentBuilder setSnapRadius(float snapRadius) {
            mOptions.snapRadius = snapRadius;
            return this;
        }
         ...
         * <i>Default: 48dp</i>
         */
        public FragmentBuilder setTouchRadius(float touchRadius) {
            mOptions.touchRadius = touchRadius;
            return this;
        }
         ...
         * <i>Default: ON_TOUCH</i>
         */
        public FragmentBuilder setGuidelines(@NonNull CropImageView.Guidelines guidelines) {
            mOptions.guidelines = guidelines;
            return this;
        }
         ...
         * <i>Default: FIT_CENTER</i>
         */
        public FragmentBuilder setScaleType(@NonNull CropImageView.ScaleType scaleType) {
            mOptions.scaleType = scaleType;
            return this;
        }
         ...
         * <i>default: true, may disable for animation or frame transition.</i>
         */
        public FragmentBuilder setShowCropOverlay(boolean showCropOverlay) {
            mOptions.showCropOverlay = showCropOverlay;
            return this;
        }
         ...
         * default: true.
         */
        public FragmentBuilder setAutoZoomEnabled(boolean autoZoomEnabled) {
            mOptions.autoZoomEnabled = autoZoomEnabled;
            return this;
        }
         ...
         * default: true.
         */
        public FragmentBuilder setMultiTouchEnabled(boolean multiTouchEnabled) {
            mOptions.multiTouchEnabled = multiTouchEnabled;
            return this;
        }
         ...
         * <i>Default: 4</i>
         */
        public FragmentBuilder setMaxZoom(int maxZoom) {
            mOptions.maxZoom = maxZoom;
            return this;
        }
         ...
         * <i>Default: 0.1</i>
         */
        public FragmentBuilder setInitialCropWindowPaddingRatio(float initialCropWindowPaddingRatio) {
            mOptions.initialCropWindowPaddingRatio = initialCropWindowPaddingRatio;
            return this;
        }
         ...
         * <i>Default: false</i>
         */
        public FragmentBuilder setFixAspectRatio(boolean fixAspectRatio) {
            mOptions.fixAspectRatio = fixAspectRatio;
            return this;
        }
         ...
         * @param aspectRatioY the height
         */
        public FragmentBuilder setAspectRatio(int aspectRatioX, int aspectRatioY) {
            mOptions.aspectRatioX = aspectRatioX;
            mOptions.aspectRatioY = aspectRatioY;
            mOptions.fixAspectRatio = true;
            return this;
         ...
         * <i>Default: 3dp</i>
         */
        public FragmentBuilder setBorderLineThickness(float borderLineThickness) {
            mOptions.borderLineThickness = borderLineThickness;
            return this;
        }
         ...
         * <i>Default: Color.argb(170, 255, 255, 255)</i>
         */
        public FragmentBuilder setBorderLineColor(int borderLineColor) {
            mOptions.borderLineColor = borderLineColor;
            return this;
        }
         ...
         * <i>Default: 2dp</i>
         */
        public FragmentBuilder setBorderCornerThickness(float borderCornerThickness) {
            mOptions.borderCornerThickness = borderCornerThickness;
            return this;
        }
         ...
         * <i>Default: 5dp</i>
         */
        public FragmentBuilder setBorderCornerOffset(float borderCornerOffset) {
            mOptions.borderCornerOffset = borderCornerOffset;
            return this;
        }
         ...
         * <i>Default: 14dp</i>
         */
        public FragmentBuilder setBorderCornerLength(float borderCornerLength) {
            mOptions.borderCornerLength = borderCornerLength;
            return this;
        }
         ...
         * <i>Default: WHITE</i>
         */
        public FragmentBuilder setBorderCornerColor(int borderCornerColor) {
            mOptions.borderCornerColor = borderCornerColor;
            return this;
        }

        public FragmentBuilder setCropWindow(RectF cropWindowRectF) {
            mOptions.cropWindowRectF = cropWindowRectF;
            return this;
        }
         ...
         * <i>Default: 1dp</i>
         */
        public FragmentBuilder setGuidelinesThickness(float guidelinesThickness) {
            mOptions.guidelinesThickness = guidelinesThickness;
            return this;
        }
         ...
         * <i>Default: Color.argb(170, 255, 255, 255)</i>
         */
        public FragmentBuilder setGuidelinesColor(int guidelinesColor) {
            mOptions.guidelinesColor = guidelinesColor;
            return this;
        }
         ...
         * <i>Default: Color.argb(119, 0, 0, 0)</i>
         */
        public FragmentBuilder setBackgroundColor(int backgroundColor) {
            mOptions.backgroundColor = backgroundColor;
            return this;
        }
         ...
         * <i>Default: 42dp, 42dp</i>
         */
        public FragmentBuilder setMinCropWindowSize(int minCropWindowWidth, int minCropWindowHeight) {
            mOptions.minCropWindowWidth = minCropWindowWidth;
            mOptions.minCropWindowHeight = minCropWindowHeight;
            return this;
        }
         ...
         * <i>Default: 40px, 40px</i>
         */
        public FragmentBuilder setMinCropResultSize(int minCropResultWidth, int minCropResultHeight) {
            mOptions.minCropResultWidth = minCropResultWidth;
            mOptions.minCropResultHeight = minCropResultHeight;
            return this;
        }
         ...
         * <i>Default: 99999, 99999</i>
         */
        public FragmentBuilder setMaxCropResultSize(int maxCropResultWidth, int maxCropResultHeight) {
            mOptions.maxCropResultWidth = maxCropResultWidth;
            mOptions.maxCropResultHeight = maxCropResultHeight;
            return this;
        }
         ...
         * <i>Default: ""</i>
         */
        public FragmentBuilder setActivityTitle(CharSequence activityTitle) {
            mOptions.activityTitle = activityTitle;
            return this;
        }
         ...
         * <i>Default: NONE, will create a temp file</i>
         */
        public FragmentBuilder setOutputUri(Uri outputUri) {
            mOptions.outputUri = outputUri;
            return this;
        }
         ...
         * <i>Default: JPEG</i>
         */
        public FragmentBuilder setOutputCompressFormat(Bitmap.CompressFormat outputCompressFormat) {
            mOptions.outputCompressFormat = outputCompressFormat;
            return this;
        }
         ...
         * <i>Default: 90</i>
         */
        public FragmentBuilder setOutputCompressQuality(int outputCompressQuality) {
            mOptions.outputCompressQuality = outputCompressQuality;
            return this;
        }
         ...
         * <i>Default: 0, 0 - not set, will not resize</i>
         */
        public FragmentBuilder setRequestedSize(int reqWidth, int reqHeight) {
            return setRequestedSize(reqWidth, reqHeight, CropImageView.RequestSizeOptions.RESIZE_INSIDE);
        }
         ...
         * <i>Default: 0, 0 - not set, will not resize</i>
         */
        public FragmentBuilder setRequestedSize(
                int reqWidth, int reqHeight, CropImageView.RequestSizeOptions options) {
            mOptions.outputRequestWidth = reqWidth;
            mOptions.outputRequestHeight = reqHeight;
            mOptions.outputRequestSizeOptions = options;
         ...
         * <i>Default: false</i>
         */
        public FragmentBuilder setNoOutputImage(boolean noOutputImage) {
            mOptions.noOutputImage = noOutputImage;
            return this;
        }
         ...
         * <i>Default: NONE - will initialize using initial crop window padding ratio</i>
         */
        public FragmentBuilder setInitialCropWindowRectangle(Rect initialCropWindowRectangle) {
            mOptions.initialCropWindowRectangle = initialCropWindowRectangle;
            return this;
        }
         ...
         * <i>Default: NONE - will read image exif data</i>
         */
        public FragmentBuilder setInitialRotation(int initialRotation) {
            mOptions.initialRotation = (initialRotation + 360) % 360;
            return this;
        }
         ...
         * <i>Default: true</i>
         */
        public FragmentBuilder setAllowRotation(boolean allowRotation) {
            mOptions.allowRotation = allowRotation;
            return this;
        }
         ...
         * <i>Default: true</i>
         */
        public FragmentBuilder setAllowFlipping(boolean allowFlipping) {
            mOptions.allowFlipping = allowFlipping;
            return this;
        }
         ...
         * <i>Default: false</i>
         */
        public FragmentBuilder setAllowCounterRotation(boolean allowCounterRotation) {
            mOptions.allowCounterRotation = allowCounterRotation;
            return this;
        }
         ...
         * <i>Default: 90</i>
         */
        public FragmentBuilder setRotationDegrees(int rotationDegrees) {
            mOptions.rotationDegrees = (rotationDegrees + 360) % 360;
            return this;
        }
         ...
         * <i>Default: false</i>
         */
        public FragmentBuilder setFlipHorizontally(boolean flipHorizontally) {
            mOptions.flipHorizontally = flipHorizontally;
            return this;
        }
         ...
         * <i>Default: false</i>
         */
        public FragmentBuilder setFlipVertically(boolean flipVertically) {
            mOptions.flipVertically = flipVertically;
            return this;
        }
         ...
         * <i>Default: null, will use resource string: crop_image_menu_crop</i>
         */
        public FragmentBuilder setCropMenuCropButtonTitle(CharSequence title) {
            mOptions.cropMenuCropButtonTitle = title;
            return this;
        }
         ...
         * <i>Default: 0</i>
         */
        public FragmentBuilder setCropMenuCropButtonIcon(@DrawableRes int drawableResource) {
            mOptions.cropMenuCropButtonIcon = drawableResource;
            return this;
        }
    }
